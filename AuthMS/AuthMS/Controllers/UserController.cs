...
namespace AuthMS.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        [Authorize(Policy = "CanViewBranchInfo")]
        [HttpGet("branches/info")]
        [ProducesResponseType(typeof(GenericResponse), 200)]
        public IActionResult GetBranchesInfo()
        {
            return Ok(new GenericResponse { Message = "Consultar sucursales en BranchOfficeMS" });
        }
